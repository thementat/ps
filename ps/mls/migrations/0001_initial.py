...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='search',
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mls.Source'),
        ),
        migrations.AddField(
            model_name='paragon_mail',
            name='search',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mls.Search'),
        ),
        migrations.AddField(
            model_name='paragon_field',
            name='search',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mls.Search'),
        ),
    ]
